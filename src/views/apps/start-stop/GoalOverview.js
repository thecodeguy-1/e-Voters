...
const GoalOverview = props => {
  ...
  return data !== null ? (
    <Card>
       <CardHeader>    <ThumbsUp />
        <CardTitle tag='h4'>Voting overview</CardTitle></CardHeader>
      <CardFooter>
      <Chart options={options} series={series} type='radialBar' height={83} />
      </CardFooter>
      <Row className='border-top text-center mx-0'>
        ...
        <Col xs='6' className='py-1'>
          ...
          <h3 className='font-weight-bolder mb-0'>{data.inProgress}</h3>d
        </Col>
      </Row>
    </Card>
  ) : null
